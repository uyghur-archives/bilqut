...
<h1>پارول ئىزدەش</h1>
<table cellpadding="2" cellspacing="0" class="righttable">

<form name="myform" action="/member/getpassword.php" method="post">
<tr>
<td width="40%" class="td_right" >ئەزا ئسمى: </td>
<td class="td_left"> <input name="username" type="text" size="30" maxlength="30" /> </td>
</tr>
<tr>
<td class="td_right">خەت ساندۇق: </td>
<td class="td_left"> <input name="email" type="text" size="30" maxlength="30" /> </td>
</tr>
<tr>
<td class="td_right"> <input name="step" type="hidden" value="2" /> </td>
<td class="td_left"> <input name="submit" type="submit" value=" كىيىنكىسى " class="btn" /> <input name="reset" type="reset" value=" قايتا يېزىش " class="btn" /></td>
</tr>
</form>
