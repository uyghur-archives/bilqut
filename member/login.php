...
<title>ئەزالار مەركىزىدە-Bilqut Uyghur web</title>
<meta name="keywords" content="ئەزالار مەركىزىدە">
<meta name="description" content="ئەزالار مەركىزىدە">
...
{
alert("ئىسمىڭىزنى يېزىڭ! ");
document.myform.username.focus();
return false;
}
if(document.myform.password.value == "")
{
alert("مەخپى نومۇرنى كىرگۈزۈڭ! ");
...
<table width="352" align="center" cellpadding="0" cellspacing="1" class="loginbox">
<form name="myform" method="post" action="/member/login.php"  onsubmit="return checkform();">
  <tr>
    <td colspan="2"><img src="/images/login.gif" /></td>
</tr>
  <tr>
    <td width="120" height="30" class="td_right">ئەزا ئسمى: </td>
    <td><input name="username" type="text" id="username" size="15" style="width:120px">
       <a href="/member/register.php" target="_blank" class="blue">تىزملىتىش</a></td>
  </tr>
  <tr>
    <td height="30" class="td_right">پارول : </td>
    <td><input name="password" type="password" id="password" size="15" style="width:120px" > <a href="/member/getpassword.php" target="_blank" class="red">ئۇنتىدىڭىز ؟</a> </td>
  </tr>
  <tr>
    <td height="30" class="td_right">Cookie：</td>
    <td><select name="cookietime" id="cookietime" style="width:120px">
          <option value="0">ساقلىماسلىق</option>
          <option value="86400" >بىركۇن ساقلاش</option>
          <option value="2592000" >بىرئاي ساقلاش</option>
          <option value="31536000" >بىريىل ساقلاش</option>
        </select></td>
  </tr>
  <tr>
    <td height="30"></td>
    <td>
      ...
      <input name="dosubmit" type="submit" id="dosubmit" size="15" value=" كىرش " class="btn">
      <input name="reset" type="reset" id="reset  size="15" value=" قايتا " class="btn">
</td>
  </tr>
</form>
</table>
